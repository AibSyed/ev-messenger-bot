...
function pickRandomUserList() {
	...
	let randomUserList1 =
		userGroup1[Math.floor(userGroup1.length * Math.random())];
	let randomUserList2 =
		userGroup2[Math.floor(userGroup2.length * Math.random())];
	let randomUserList3 =
		userGroup3[Math.floor(userGroup3.length * Math.random())];
	let randomUserList4 =
		userGroup4[Math.floor(userGroup4.length * Math.random())];
	let randomUserList5 =
